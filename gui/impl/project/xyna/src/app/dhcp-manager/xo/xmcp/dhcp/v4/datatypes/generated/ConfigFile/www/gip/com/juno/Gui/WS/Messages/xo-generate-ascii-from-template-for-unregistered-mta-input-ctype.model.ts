...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.ConfigFile.www.gip.com.juno.Gui.WS.Messages', 'GenerateAsciiFromTemplateForUnregisteredMtaInput_ctype')
export class XoGenerateAsciiFromTemplateForUnregisteredMtaInputctype extends XoXSDBaseModel {
...
@XoArrayClass(XoGenerateAsciiFromTemplateForUnregisteredMtaInputctype)
export class XoGenerateAsciiFromTemplateForUnregisteredMtaInputctypeArray extends XoArray<XoGenerateAsciiFromTemplateForUnregisteredMtaInputctype> {
}
