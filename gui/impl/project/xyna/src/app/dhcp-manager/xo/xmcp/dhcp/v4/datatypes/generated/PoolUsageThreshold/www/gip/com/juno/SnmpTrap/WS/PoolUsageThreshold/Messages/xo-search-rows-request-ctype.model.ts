...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.PoolUsageThreshold.www.gip.com.juno.SnmpTrap.WS.PoolUsageThreshold.Messages', 'SearchRowsRequest_ctype')
export class XoSearchRowsRequestctype extends XoXSDBaseModel {
    ...
    searchRowsInput: XoRowctype = new XoRowctype();
