...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Class0.www.gip.com.juno.DHCP.WS.Class0.Messages', 'SearchRowsRequest_ctype')
export class XoSearchRowsRequestctype extends XoXSDBaseModel {
    ...
    searchRowsInput: XoRowctype1 = new XoRowctype1();
