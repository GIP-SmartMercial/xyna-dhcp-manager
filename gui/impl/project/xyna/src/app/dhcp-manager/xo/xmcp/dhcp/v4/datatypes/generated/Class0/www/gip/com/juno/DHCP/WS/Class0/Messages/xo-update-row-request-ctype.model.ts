...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Class0.www.gip.com.juno.DHCP.WS.Class0.Messages', 'UpdateRowRequest_ctype')
export class XoUpdateRowRequestctype extends XoXSDBaseModel {
    ...
    updateRowInput: XoRowctype1 = new XoRowctype1();
