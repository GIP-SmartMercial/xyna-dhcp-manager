...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Target.www.gip.com.juno.DHCP.WS.Target.Messages', 'Row_ctype')
export class XoRowctype extends XoXSDBaseModel {
    ...
    @XoProperty()
    dppFixedAttributeId: string;


    @XoProperty()
    dppFixedAttribute: string;
    ...
    @XoProperty()
    standortGruppe: string;


    @XoProperty()
    connectDataID: string;
