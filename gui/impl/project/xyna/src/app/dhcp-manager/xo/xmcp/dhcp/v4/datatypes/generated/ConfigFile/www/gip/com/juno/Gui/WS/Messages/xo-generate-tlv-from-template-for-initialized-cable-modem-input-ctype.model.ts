...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.ConfigFile.www.gip.com.juno.Gui.WS.Messages', 'GenerateTlvFromTemplateForInitializedCableModemInput_ctype')
export class XoGenerateTlvFromTemplateForInitializedCableModemInputctype extends XoXSDBaseModel {
...
@XoArrayClass(XoGenerateTlvFromTemplateForInitializedCableModemInputctype)
export class XoGenerateTlvFromTemplateForInitializedCableModemInputctypeArray extends XoArray<XoGenerateTlvFromTemplateForInitializedCableModemInputctype> {
}
