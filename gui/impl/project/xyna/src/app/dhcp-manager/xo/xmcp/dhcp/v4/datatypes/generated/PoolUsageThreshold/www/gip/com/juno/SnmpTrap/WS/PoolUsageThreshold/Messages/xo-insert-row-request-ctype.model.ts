...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.PoolUsageThreshold.www.gip.com.juno.SnmpTrap.WS.PoolUsageThreshold.Messages', 'InsertRowRequest_ctype')
export class XoInsertRowRequestctype extends XoXSDBaseModel {
    ...
    insertRowInput: XoRowctype = new XoRowctype();


}

@XoArrayClass(XoInsertRowRequestctype)
export class XoInsertRowRequestctypeArray extends XoArray<XoInsertRowRequestctype> {
}
