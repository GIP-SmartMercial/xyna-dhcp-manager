...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.PoolUsageThreshold.www.gip.com.juno.SnmpTrap.WS.PoolUsageThreshold.Messages', 'Payload_ctype')
export class XoPayloadctype extends XoXSDBaseModel {
    ...
    @XoProperty()
    deleteRowsWithNullConditionsOutput: string;


    @XoProperty(XoRowctype)
    updateRowPkWithNullConditionsOutput: XoRowctype = new XoRowctype();
