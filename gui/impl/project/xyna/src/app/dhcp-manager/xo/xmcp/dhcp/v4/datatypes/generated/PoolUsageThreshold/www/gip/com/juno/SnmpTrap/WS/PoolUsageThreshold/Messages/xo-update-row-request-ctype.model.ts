...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.PoolUsageThreshold.www.gip.com.juno.SnmpTrap.WS.PoolUsageThreshold.Messages', 'UpdateRowRequest_ctype')
export class XoUpdateRowRequestctype extends XoXSDBaseModel {
    ...
    updateRowInput: XoRowctype = new XoRowctype();


}

@XoArrayClass(XoUpdateRowRequestctype)
export class XoUpdateRowRequestctypeArray extends XoArray<XoUpdateRowRequestctype> {
}
