...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Standort.www.gip.com.juno.DHCP.WS.Standort.Messages', 'Payload_ctype')
export class XoPayloadctype extends XoXSDBaseModel {
    ...
    colValuesDistinctOutput: XoColValuesDistinctctype = new XoColValuesDistinctctype();
