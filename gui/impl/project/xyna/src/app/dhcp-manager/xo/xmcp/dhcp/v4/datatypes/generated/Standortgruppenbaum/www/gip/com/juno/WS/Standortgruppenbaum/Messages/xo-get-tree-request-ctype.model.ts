...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Standortgruppenbaum.www.gip.com.juno.WS.Standortgruppenbaum.Messages', 'GetTreeRequest_ctype')
export class XoGetTreeRequestctype extends XoXSDBaseModel {
...
@XoArrayClass(XoGetTreeRequestctype)
export class XoGetTreeRequestctypeArray extends XoArray<XoGetTreeRequestctype> {
}
