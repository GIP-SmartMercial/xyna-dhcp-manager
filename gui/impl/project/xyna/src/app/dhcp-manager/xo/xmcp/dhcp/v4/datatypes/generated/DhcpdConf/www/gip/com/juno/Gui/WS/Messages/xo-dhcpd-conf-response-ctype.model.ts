...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.DhcpdConf.www.gip.com.juno.Gui.WS.Messages', 'DhcpdConfResponse_ctype')
export class XoDhcpdConfResponsectype extends XoXSDBaseModel {
...
@XoArrayClass(XoDhcpdConfResponsectype)
export class XoDhcpdConfResponsectypeArray extends XoArray<XoDhcpdConfResponsectype> {
}
