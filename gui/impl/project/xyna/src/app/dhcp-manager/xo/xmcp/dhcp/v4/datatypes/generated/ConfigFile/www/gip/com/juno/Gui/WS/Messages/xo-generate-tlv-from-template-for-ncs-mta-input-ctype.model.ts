...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.ConfigFile.www.gip.com.juno.Gui.WS.Messages', 'GenerateTlvFromTemplateForNcsMtaInput_ctype')
export class XoGenerateTlvFromTemplateForNcsMtaInputctype extends XoXSDBaseModel {
...
@XoArrayClass(XoGenerateTlvFromTemplateForNcsMtaInputctype)
export class XoGenerateTlvFromTemplateForNcsMtaInputctypeArray extends XoArray<XoGenerateTlvFromTemplateForNcsMtaInputctype> {
}
