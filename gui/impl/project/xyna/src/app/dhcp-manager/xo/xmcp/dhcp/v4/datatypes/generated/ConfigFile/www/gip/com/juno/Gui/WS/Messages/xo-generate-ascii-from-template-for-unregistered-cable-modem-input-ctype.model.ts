...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.ConfigFile.www.gip.com.juno.Gui.WS.Messages', 'GenerateAsciiFromTemplateForUnregisteredCableModemInput_ctype')
export class XoGenerateAsciiFromTemplateForUnregisteredCableModemInputctype extends XoXSDBaseModel {
...
@XoArrayClass(XoGenerateAsciiFromTemplateForUnregisteredCableModemInputctype)
export class XoGenerateAsciiFromTemplateForUnregisteredCableModemInputctypeArray extends XoArray<XoGenerateAsciiFromTemplateForUnregisteredCableModemInputctype> {
}
