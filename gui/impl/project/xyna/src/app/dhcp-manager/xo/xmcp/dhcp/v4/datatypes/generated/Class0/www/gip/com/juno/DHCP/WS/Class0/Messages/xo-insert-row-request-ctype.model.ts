...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Class0.www.gip.com.juno.DHCP.WS.Class0.Messages', 'InsertRowRequest_ctype')
export class XoInsertRowRequestctype extends XoXSDBaseModel {
    ...
    insertRowInput: XoRowctype1 = new XoRowctype1();
