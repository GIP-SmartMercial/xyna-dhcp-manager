...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Standortgruppenbaum.www.gip.com.juno.WS.Standortgruppenbaum.Messages', 'Payload_ctype')
export class XoPayloadctype extends XoXSDBaseModel {


    @XoProperty()
    getTreeStringOutput: string;
