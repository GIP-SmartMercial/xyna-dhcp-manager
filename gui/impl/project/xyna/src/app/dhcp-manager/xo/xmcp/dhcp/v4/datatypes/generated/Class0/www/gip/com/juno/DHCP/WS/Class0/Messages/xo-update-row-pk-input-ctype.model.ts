...
@XoObjectClass(XoXSDBaseModel, 'xmcp.dhcp.v4.datatypes.generated.Class0.www.gip.com.juno.DHCP.WS.Class0.Messages', 'UpdateRowPkInput_ctype')
export class XoUpdateRowPkInputctype extends XoXSDBaseModel {


    @XoProperty(XoRowctype1)
    conditions: XoRowctype1 = new XoRowctype1();


    @XoProperty(XoRowctype1)
    newValues: XoRowctype1 = new XoRowctype1();
