...
import { ClassListComponent, ClassListComponentData } from './stack-items/class-list/class-list.component';


@Component({
    selector: 'class-configurator-component',
    templateUrl: './class-configurator.component.html',
    styleUrls: ['./class-configurator.component.scss']
})
export class ClassConfiguratorComponent extends DHCPManagerGenericRouteComponent implements OnDestroy {
    ...
    constructor(injector: Injector, /* is protected */ apiService: DHCPApiService, i18nService: I18nService, dialogService: XcDialogService) {
        ...
        item.setTemplate(new XcComponentTemplate(ClassListComponent, <ClassListComponentData>{stackItem: item, communicationData: {rootRef: this}}));
