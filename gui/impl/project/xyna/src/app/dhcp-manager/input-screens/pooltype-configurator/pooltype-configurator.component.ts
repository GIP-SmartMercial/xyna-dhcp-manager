...
import { PooltypeListComponent, PooltypeListComponentData } from './stack-items/pooltype-list/pooltype-list.component';


@Component({
    selector: 'pooltype-configurator-component',
    templateUrl: './pooltype-configurator.component.html',
    styleUrls: ['./pooltype-configurator.component.scss']
})
export class PooltypeConfiguratorComponent extends DHCPManagerGenericRouteComponent implements OnDestroy {
    ...
    constructor(injector: Injector, /* is protected */ apiService: DHCPApiService, i18nService: I18nService, dialogService: XcDialogService) {
        ...
        item.setTemplate(new XcComponentTemplate(PooltypeListComponent, <PooltypeListComponentData>{stackItem: item, communicationData: {rootRef: this}}));
